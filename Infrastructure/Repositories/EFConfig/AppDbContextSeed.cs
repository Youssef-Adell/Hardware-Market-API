...
public static class AppDbContextSeed
{
    public static async Task SeedAsync(this AppDbContext appDbContext)
    {
        ...
        if (!await appDbContext.ProductReviews.AnyAsync())
        {
            ...
            list.Add(new ProductReview() { ProductId = 1, CustomerEmail = "customer1@example.com", Rating = 4, Comment = "Great product!" });
            list.Add(new ProductReview() { ProductId = 1, CustomerEmail = "customer2@example.com", Rating = 5, Comment = "Excellent quality!" });
            list.Add(new ProductReview() { ProductId = 1, CustomerEmail = "customer3@example.com", Rating = 3, Comment = "Could be better." });
            list.Add(new ProductReview() { ProductId = 1, CustomerEmail = "customer4@example.com", Rating = 2, Comment = "Not satisfied." });
            list.Add(new ProductReview() { ProductId = 2, CustomerEmail = "customer5@example.com", Rating = 5, Comment = "Love it!" });
            list.Add(new ProductReview() { ProductId = 2, CustomerEmail = "customer6@example.com", Rating = 4, Comment = "Good value for money." });
            list.Add(new ProductReview() { ProductId = 2, CustomerEmail = "customer7@example.com", Rating = 1, Comment = "Terrible product." });
